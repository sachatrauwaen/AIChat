...
{
    class GetModuleTool : ITool
    {
        public string Name => "Get Module content";

        public string Description => "Get content of module";

        public MethodInfo Function => typeof(GetModuleTool).GetMethod(nameof(GetModule));
